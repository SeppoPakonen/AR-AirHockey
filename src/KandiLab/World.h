...
public:
	...
	virtual void DrawPolygon(const b2Vec2* v, int vertexCount, const b2Color& color);
	virtual void DrawSolidPolygon(const b2Vec2* v, int vertexCount, const b2Color& color);
	virtual void DrawCircle(const b2Vec2& center, float32 radius, const b2Color& color);
	virtual void DrawSolidCircle(const b2Vec2& center, float32 radius, const b2Vec2& axis, const b2Color& color);
	virtual void DrawSegment(const b2Vec2& p1, const b2Vec2& p2, const b2Color& color);
	virtual void DrawTransform(const b2Transform& xf);
	virtual void DrawPoint(const b2Vec2& p0, float32 size, const b2Color& color);
